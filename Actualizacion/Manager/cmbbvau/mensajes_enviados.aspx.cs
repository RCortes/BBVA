...
public partial class mensajes_enviados : System.Web.UI.Page
{
    ...
    private void LoadGrid()
    {
        ...
        else
        {
            ...
            {
                xmlmano += "<Users>";
                xmlmano += "<Mensaje>" + (RemoveSpecialCharacters(Notification[i].ChildNodes[8].InnerText)).Trim() + "</Mensaje>";
                ...
                xmlmano += "<Nombre>" + (RemoveSpecialCharacters(Notification[i].ChildNodes[6].InnerText)).Trim() + "</Nombre>";
                xmlmano += "</Users>";
            }
        }
    ...
    private void CargarGrid(string rut)
    {
        ...
        else
        {
            for (int i = 0; i < Notification.Count; i++)
            {
                ...
                xCantidad.InnerText = Notification[i].ChildNodes[9].InnerText;
    ...
    {
        string xml = Regex.Replace(str, @"[^\w\.@-]", " ", RegexOptions.Compiled);
